...
{
    /*
        Global Singleton: One copy of the data shared across the entire app's lifetime.
    ...
    public static class ServersRepository
    {
        ...
        public static void ToggleServer(int serverId)
        {
            //Get target server
            var server = servers.FirstOrDefault(s => s.Id == (int)serverId);
